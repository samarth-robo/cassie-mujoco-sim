               ...
               bool zero_hip_yaw)
{
    ...
    double offset_footJoint2midFoot = sqrt(pow(0.01762, 2) + pow(0.05219, 2));
    mjtNum left_x[3] = {lx, ly, lz + offset_footJoint2midFoot};
    mjtNum right_x[3] = {rx, ry, rz + offset_footJoint2midFoot};
    ...
    std::cout << "Left desired = " << left_x_des << std::endl;
    std::cout << "Left actual = " << left_x_pos << std::endl;
    std::cout << "Right desired = " << right_x_des << std::endl;
    std::cout << "Right actual = " << right_x_pos << std::endl;
